...
CREATE TABLE IF NOT EXISTS `punto-de-venta-db`.`Productos` (
  ...
  UNIQUE INDEX `CodigoDeBarras_UNIQUE` (`CodigoDeBarras` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `punto-de-venta-db`.`Empleados` (
  ...
  UNIQUE INDEX `RutEmpleado_UNIQUE` (`RutEmpleado` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `punto-de-venta-db`.`Bodegas` (
  ...
  UNIQUE INDEX `NombreBodega_UNIQUE` (`NombreBodega` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `punto-de-venta-db`.`AccionesProductos` (
  ...
  UNIQUE INDEX `Accion_UNIQUE` (`AccionProductos` ASC) VISIBLE)
ENGINE = InnoDB;
